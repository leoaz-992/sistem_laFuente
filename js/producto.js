...
function editProduct(button) {
  ...
  document.getElementById("product-price").value = parseFloat(
    productInfo[1].replace("Precio: $", "")
  );
  document.getElementById("product-quantity").value = parseInt(
    productInfo[2].replace("Cantidad: ", "")
  );
